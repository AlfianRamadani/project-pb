                ...
                <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                    <div class="grow">
                        <div class="flex flex-col md:flex-row  md:items-center gap-0.5 md:gap-1">
                            ...
                            <!-- Dropdown -->
                            <div
                                class="hs-dropdown group relative [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false]">
                            ...
                            <div
                                ...
                                <div class="hs-dropdown-menu group-hover:opacity-100 absolute transition-opacity duration-300 opacity-0 hidden group-hover:relative w-full md:w-52 z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-[18px] after:w-0.5 after:h-[calc(100%-0.25rem)] after:bg-gray-100 dark:md:bg-neutral-800 dark:after:bg-neutral-700"
                                    ...
                                    <div class="py-1 md:px-1 space-y-0.5">
                                        <a class="flex items-center p-2 text-sm text-gray-800 rounded-lg md:px-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                                            href="{{route('superiority.achievement')}}">
                                            Prestasi
                                        </a>
                                        ...
                                        <a class="flex items-center p-2 text-sm text-gray-800 rounded-lg md:px-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                                            href="superiority.facility">
                                            Fasilitas
                                        </a>

                                        <a class="flex items-center p-2 text-sm text-gray-800 rounded-lg md:px-3 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                                            href="superiority.extracurricular">
                                            Eskul
                                        </a>
